...
import com.example.lenovo.food.ViewHolder.CartAdapter;
...
public class Cart extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        requests=database.getReference("Запити");
    ...
    private void showAlertDialog() {
        ...
        alertDialog.setTitle("Ще один крок");
        alertDialog.setMessage("Введіть вашу адресу: ");
        ...
        alertDialog.setPositiveButton("Так", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                Toast.makeText(Cart.this, "Дякую", Toast.LENGTH_SHORT).show();
                finish();
            }
        });
