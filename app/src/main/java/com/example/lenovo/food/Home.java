...
import com.example.lenovo.food.Model.Category;
import com.example.lenovo.food.Model.Order;
import com.example.lenovo.food.ViewHolder.MenuViewHolder;
...
public class Home extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_menu) {
            Intent cartIntent = new Intent(Home.this,FoodList.class);
            startActivity(cartIntent);
        } else if (id == R.id.nav_cart) {
            Intent orderIntent = new Intent(Home.this,Cart.class);
            startActivity(orderIntent);
        } else if (id == R.id.nav_orders) {
            Intent orderIntent = new Intent(Home.this,activity_seat_selection.class);
            startActivity(orderIntent);
